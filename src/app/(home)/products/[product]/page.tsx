  ...
  return (
    <>
                  ...
                  <div className="product-colors mb-5">
                    <ul>
                      {product.colorVariations.map((variation, index) => (
                        <li
                          key={index}
                          className={`color-circle ${selectedVariation === variation ? ' border-red-500 border-8' : ''}`}
      ...
      <div className="container px-5 py-14 mx-auto">
        ...
        <RelatedProducts currentProductId={product._id} categorySlug={product.categorySlug} />
      </div>
